				...
				<div class="container">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-12">
							<!-- Logo -->
							<div class="logo">
								<a href="index.html"><img src="Styling/images/logo.png" alt="logo"></a>
							</div>
							<!--/ End Logo -->
							<!-- Search Form -->
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="Styling/images/logo2.png" alt="#"></a>
							</div>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="right">
								<img src="Styling/images/payments.png" alt="#">
							</div>
						</div>
					</div>
				</div>
